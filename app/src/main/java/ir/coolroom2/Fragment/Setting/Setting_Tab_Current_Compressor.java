...
public class Setting_Tab_Current_Compressor extends Fragment {
    ...
    RadioButton current_v3_manual, current_v3_automatic;

    DatabaseHandler db;

    Button manual_compressor;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_setting_tab_current_compressor, container, false);

        db = new DatabaseHandler(getActivity());
        userModel = db.getFirstUser_for_room(Config.currentRoomID);

        findview(view);
        current_v1.setText(Float.parseFloat(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V1)) + "");
        current_v2.setText(Float.parseFloat(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V2)) + "");
        current_v4.setText(Integer.parseInt(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V4)) + "");
        current_v5.setText(Integer.parseInt(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V5)) + "");
        current_v6.setText(Integer.parseInt(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V6)) + "");
        current_v7.setText(Integer.parseInt(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V7)) + "");
        loadRepeat();
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V3).equals("0")) {
                    ...
                    manual_compressor.setBackground(getResources().getDrawable(R.drawable.gradient));
                    manual_compressor.setEnabled(true);
                    manual_compressor.setClickable(true);
                    manual_compressor.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            ...
                            save_difrast.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    prepareDataAndSendSms.send_direct_compressor(userModel.get_mobile(), "02");
                            ...
                            msg.setText("با اینکار شما تنظیمات کمپرسور دستی را ارسال می کنید." + "\n" + "مطمئن هستید ؟");
                    ...
                    manual_compressor.setBackgroundColor(Color.parseColor("#dadada"));
                    manual_compressor.setEnabled(false);
                    manual_compressor.setClickable(false);
                }
            }
        }, 1000);
    ...
    void findview(View view) {
        ...
        manual_compressor = view.findViewById(R.id.manual_compressor);

    }

    void loadRepeat() {

        repeatListener1_1 = new RepeatListener(40, 40, 99f, 1f, 0.1f, true, Float.parseFloat(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V1)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Config.general_data_setting.put(Config.KEY_CURRENT_COMPRESOR_V1, Math.round(repeatListener1_1.result) + "");
            }
        }, getContext());
        repeatListener1_2 = new RepeatListener(40, 40, 99f, 1f, (repeatListener1_1.Count_num), false, Float.parseFloat(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V1)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        repeatListener2_1 = new RepeatListener(40, 40, 99f, 0f, 0.1f, true, Float.parseFloat(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V2)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Config.general_data_setting.put(Config.KEY_CURRENT_COMPRESOR_V2, Math.round(repeatListener2_1.result) + "");
            }
        }, getContext());
        repeatListener2_2 = new RepeatListener(40, 40, 99f, 0f, (repeatListener2_1.Count_num), false, Float.parseFloat(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V2)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        repeatListener4_1 = new RepeatListener(40, 40, 300f, 5f, 1f, true, Float.parseFloat(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V4)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Config.general_data_setting.put(Config.KEY_CURRENT_COMPRESOR_V4, Math.round(repeatListener4_1.result) + "");
            }
        }, getContext());
        repeatListener4_2 = new RepeatListener(40, 40, 300f, 5f, (repeatListener4_1.Count_num), false, Float.parseFloat(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V4)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        repeatListener5_1 = new RepeatListener(40, 40, 99f, 1f, 1f, true, Float.parseFloat(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V5)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Config.general_data_setting.put(Config.KEY_CURRENT_COMPRESOR_V5, Math.round(repeatListener5_1.result) + "");
            }
        }, getContext());
        repeatListener5_2 = new RepeatListener(40, 40, 99f, 1f, (repeatListener5_1.Count_num), false, Float.parseFloat(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V5)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        repeatListener6_1 = new RepeatListener(40, 40, 15f, 5f, 1f, true, Float.parseFloat(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V6)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Config.general_data_setting.put(Config.KEY_CURRENT_COMPRESOR_V6, Math.round(repeatListener6_1.result) + "");
            }
        }, getContext());
        repeatListener6_2 = new RepeatListener(40, 40, 15f, 5f, (repeatListener6_1.Count_num), false, Float.parseFloat(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V6)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        repeatListener7_1 = new RepeatListener(40, 40, 20f, 1f, 1f, true, Float.parseFloat(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V7)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Config.general_data_setting.put(Config.KEY_CURRENT_COMPRESOR_V7, Math.round(repeatListener7_1.result) + "");
            }
        }, getContext());
        repeatListener7_2 = new RepeatListener(40, 40, 20f, 1f, (repeatListener7_1.Count_num), false, Float.parseFloat(Config.general_data_setting.get(Config.KEY_CURRENT_COMPRESOR_V7)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
