 ...
 */
public class Setting_Tab_Pressure_Low_Gas extends Fragment {

    RadioGroup pressure_v1;
    ...
    RepeatListener repeatListener2_1,
            repeatListener2_2,
            repeatListener3_1,
            repeatListener3_2,
            repeatListener4_1,
    ...
    Button manual_lowgas;
    UserModel userModel = null;


    public Setting_Tab_Pressure_Low_Gas() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_setting__tab__pressure__low__gas, container, false);
        ...
        pressure_v2.setText(Integer.parseInt(Config.general_data_setting.get(Config.KEY_PRESSURE_LOW_GAS_V2)) + "");
        pressure_v3.setText(Integer.parseInt(Config.general_data_setting.get(Config.KEY_PRESSURE_LOW_GAS_V3)) + "");
        pressure_v4.setText(Integer.parseInt(Config.general_data_setting.get(Config.KEY_PRESSURE_LOW_GAS_V4)) + "");
        pressure_v5.setText(Integer.parseInt(Config.general_data_setting.get(Config.KEY_PRESSURE_LOW_GAS_V5)) + "");
        ...
        final LinearLayout linear_right2 = (LinearLayout) view.findViewById(R.id.linear_right2);
        final TextView delay_on_connect_title = (TextView) view.findViewById(R.id.delay_on_connect_title);

        Config.Pressure_radio_btn_low_gas_manual = pressure_v1_manual;
        Config.Pressure_radio_btn_low_gas_automatic = pressure_v1_automatic;


        if (Config.general_data_setting.get(Config.KEY_PRESSURE_LOW_GAS_V1).equals("0")) {
            ...
            linear_right2.setBackground(getResources().getDrawable(R.drawable.info_box_header_right));
            pressure_v4_up.setOnTouchListener(repeatListener4_1);
            pressure_v4_down.setOnTouchListener(repeatListener4_2);
            ...
            manual_lowgas.setBackgroundColor(Color.parseColor("#dadada"));
            manual_lowgas.setEnabled(false);
            manual_lowgas.setClickable(false);


        } else {
            pressure_v1.clearCheck();
            v3_automatic.setChecked(true);
            if (Config.setting_tab_pressure_checked_radio_btn_id == R.id.pressure_v1_pomp_down) {
                final Dialog dialog = new Dialog(getActivity());
                dialog.setContentView(R.layout.dialog_custom_alert);
                ((TextView) dialog.findViewById(R.id.description)).setText("در این حالت امکان انتخاب ریست دستی وجود ندارد.");
                ((TextView) dialog.findViewById(R.id.posetive_btn_text)).setText("تایید");
                ((TextView) dialog.findViewById(R.id.title)).setText("اخطار");
                ...
                linear_right2.setBackground(getResources().getDrawable(R.drawable.forground_gray));
                pressure_v4_up.setOnTouchListener(null);
                pressure_v4_down.setOnTouchListener(null);

                manual_lowgas.setBackground(getResources().getDrawable(R.drawable.gradient));
                manual_lowgas.setEnabled(true);
                manual_lowgas.setClickable(true);
                manual_lowgas.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        ...
                        save_difrast.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                prepareDataAndSendSms.send_direct_lowgas(userModel.get_mobile(), "04");
                        ...
                        msg.setText("با اینکار شما تنظیمات فشار گاز پایین دستی را ارسال می کنید." + "\n" + "مطمئن هستید ؟");
    ...
    void findview(View view) {
        ...
        manual_lowgas = view.findViewById(R.id.manual_lowgas);

    }

    void loadRepeat() {

        repeatListener2_1 = new RepeatListener(50, 50, 100f, 0f, 1f, true,
                Float.parseFloat(Config.general_data_setting.get(Config.KEY_PRESSURE_LOW_GAS_V2)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Config.general_data_setting.put(Config.KEY_PRESSURE_LOW_GAS_V2, Math.round(repeatListener2_1.result) + "");
            }
        }, getContext());
        repeatListener2_2 = new RepeatListener(50, 50, 100f, 0f, (repeatListener2_1.Count_num), false,
                Float.parseFloat(Config.general_data_setting.get(Config.KEY_PRESSURE_LOW_GAS_V2)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        repeatListener3_1 = new RepeatListener(50, 50, 30f, 2f, 1f, true,
                Float.parseFloat(Config.general_data_setting.get(Config.KEY_PRESSURE_LOW_GAS_V3)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Config.general_data_setting.put(Config.KEY_PRESSURE_LOW_GAS_V3, Math.round(repeatListener3_1.result) + "");
            }
        }, getContext());
        repeatListener3_2 = new RepeatListener(50, 50, 30f, 2f, (repeatListener3_1.Count_num), false,
                Float.parseFloat(Config.general_data_setting.get(Config.KEY_PRESSURE_LOW_GAS_V3)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        repeatListener4_1 = new RepeatListener(50, 50, 300f, 5f, 1f, true,
                Float.parseFloat(Config.general_data_setting.get(Config.KEY_PRESSURE_LOW_GAS_V4)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Config.general_data_setting.put(Config.KEY_PRESSURE_LOW_GAS_V4, Math.round(repeatListener4_1.result) + "");
            }
        }, getContext());
        repeatListener4_2 = new RepeatListener(50, 50, 300f, 5f, (repeatListener4_1.Count_num), false,
                Float.parseFloat(Config.general_data_setting.get(Config.KEY_PRESSURE_LOW_GAS_V4)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        repeatListener5_1 = new RepeatListener(50, 50, 99f, 1f, 1f, true,
                Float.parseFloat(Config.general_data_setting.get(Config.KEY_PRESSURE_LOW_GAS_V5)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                Config.general_data_setting.put(Config.KEY_PRESSURE_LOW_GAS_V5, Math.round(repeatListener5_1.result) + "");
            }
        }, getContext());
        repeatListener5_2 = new RepeatListener(50, 50, 99f, 1f, (repeatListener5_1.Count_num), false,
                Float.parseFloat(Config.general_data_setting.get(Config.KEY_PRESSURE_LOW_GAS_V5)), new View.OnClickListener() {
            @Override
            public void onClick(View v) {
